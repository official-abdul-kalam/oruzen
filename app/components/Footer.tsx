                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400">
                            <li><a href="/software/horizon-editor" className="hover:text-blue-400 transition-colors">Horizon Video Editor</a></li>
                            <li><a href="/software/neutron-code" className="hover:text-blue-400 transition-colors">Neutron IDE</a></li>
                            <li><a href="/software/aegis-shield" className="hover:text-blue-400 transition-colors">Aegis Antivirus</a></li>
                            <li><a href="/software/zenith-browser" className="hover:text-blue-400 transition-colors">Zenith Browser</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-400">
                            ...
                            <li><a href="/press" className="hover:text-blue-400 transition-colors">Press Kit</a></li>
