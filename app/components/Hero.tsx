                ...
                <div className="max-w-3xl">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full">
                            <Link href="/signup" className="w-full sm:w-auto px-8 py-4 bg-primary text-white font-medium rounded-lg hover:bg-slate-800 transition-all text-center transform hover:-translate-y-1 shadow-lg hover:shadow-xl">
                                Start Building
                            </Link>
                            <Link href="/about" className="w-full sm:w-auto px-8 py-4 bg-white/80 backdrop-blur-sm text-text-main border border-border font-medium rounded-lg hover:bg-white transition-all text-center">
                                Learn More
                            </Link>
                        </div>
                    </motion.div>
