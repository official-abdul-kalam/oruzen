...
import { Loader2, Mail, Lock, AlertCircle, Eye, EyeOff, Smartphone, Facebook, Instagram, Twitter } from "lucide-react";
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-2">
                                <p className="text-center text-sm text-white/50">
                                    Don't have an account? <Link href={`/signup?redirect_url=${encodeURIComponent(redirectUrl)}`} className="text-white font-bold hover:underline">Sign up</Link>
                                </p>
                            </div>
                        </div>
                    ) : (
...
export default function SignInPage() {
    return (
        <div className="h-screen overflow-hidden relative flex bg-[#1a0f0a]">
            ...
            <AuthNavbar ctaText="Sign Up" ctaHref="/signup" />
            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row max-w-7xl mx-auto px-6 md:px-12 items-center h-full">
                ...
                <div className="flex-1 w-full text-left md:pr-12 text-white mb-16 md:mb-0 mt-12 md:mt-0">
                    ...
                    <p className="text-xl md:text-2xl text-white/80 max-w-xl leading-relaxed mb-12 drop-shadow-md fade-up" style={{ animationDelay: '0.1s' }}>
                        Pick up right where you left off. Access your projects, tools, and creative community.
                    </p>
